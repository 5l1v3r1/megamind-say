# megamind-say
A simple command line tool to make memes using the megamind "no bitches?" template

# usage
```sh
python3 mmsay.py <your message here>
```

Example:

```sh
nexus@popos:~$ python3 mmsay.py no explanation?
